...
#pragma omp parallel for schedule(dynamic, 1)
  ...
  diskann::cout << std::setw(6) << "L" << std::setw(12) << "Beamwidth"
                << std::setw(10) << "QPS" << std::setw(16) << "Mean Latency"
                << std::setw(16) << "99.9 Latency" << std::setw(10)
                << "Mean IOs" << std::setw(16) << "IO time(us)" << std::setw(12)
                << "CPU (us)";
  if (calc_recall_flag) {
  ...
  for (uint32_t test_id = 0; test_id < Lvec.size(); test_id++) {
    ...
    std::cout << "Total Heap Allocated: " << mi.arena / (1024 * 1024)
              << " MB\n";
...
#pragma omp parallel for schedule(dynamic, 1)
    ...
    */
    ...
    diskann::cout << std::setw(6) << L << std::setw(12) << optimized_beamwidth
                  << std::setw(10) << qps << std::setw(16) << mean_latency
                  << std::setw(16) << latency_999 << std::setw(10) << mean_ios
                  << std::setw(16) << mean_io_us << std::setw(12) << mean_cpuus;
    if (calc_recall_flag) {
